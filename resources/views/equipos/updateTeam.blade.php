...
@section('content')
   ...
   <form action="{{ route('equipos.update', $equipo->id) }}" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto mt-8 mb-6">
    ...
    <button type="submit" class="px-4 py-2 text-white rounded-lg hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50" style="background-color: rgb(100, 181, 246);">Actualizar equipo</button>
</form>
